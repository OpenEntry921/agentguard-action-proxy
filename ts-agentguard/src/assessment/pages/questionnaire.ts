...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .section-kicker { margin-bottom: 8px; color: var(--accent); font-weight: 700; letter-spacing: .14em; text-transform: uppercase; }
    h2 { margin: 0 0 10px; }
    .question-card { margin: 0; padding: 22px; border: 1px solid var(--border); border-radius: 20px; background: rgba(11, 23, 40, .72); }
    legend { display: flex; flex-wrap: wrap; gap: 10px 14px; align-items: center; padding: 0 8px; font-weight: 600; }
    .domain { color: var(--accent); }
    .question-number { color: var(--muted); font-size: .92rem; }
    .question-title { margin: 16px 0 18px; color: var(--text); font-weight: 600; }
    ...
    button, a { display: inline-flex; align-items: center; min-height: 46px; border-radius: 14px; font-weight: 600; padding: 0 20px; text-decoration: none; }
    ...
    .form-message { min-height: 28px; margin: 18px 0 0; color: var(--warn); font-weight: 600; }
