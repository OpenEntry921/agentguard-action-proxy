...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    body { margin: 0; min-height: 100vh; font-family: Helvetica, "Helvetica Neue", Arial, "Apple SD Gothic Neo", "Noto Sans KR", sans-serif; background: radial-gradient(circle at top left, #12345a 0, var(--bg) 34rem); color: var(--text); }
    ...
    .eyebrow { color: var(--accent); font-size: .9rem; font-weight: 600; letter-spacing: .16em; margin-bottom: 18px; text-transform: uppercase; }
    ...
    .button { display: inline-flex; align-items: center; justify-content: center; min-height: 48px; border: 0; border-radius: 14px; background: var(--button); color: white; font: inherit; font-weight: 600; padding: 0 22px; text-decoration: none; box-shadow: 0 14px 34px rgba(47, 128, 237, .32); cursor: pointer; }
    ...
    select { min-height: 48px; min-width: min(100%, 320px); border: 1px solid var(--border); border-radius: 14px; background: rgba(7, 17, 31, .72); color: var(--text); font: inherit; font-weight: 600; padding: 0 14px; }
