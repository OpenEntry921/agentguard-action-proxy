...
const scenarioLibrary: Record<IndustryType, ScenarioRule> = {
  HEALTHCARE: {
    ...
    triggerDomain: "PRIVACY_DATA_PROTECTION",
    threshold: 3,
  ...
  FINANCIAL: {
    industry: "FINANCIAL",
    scenario: "AI AI가 승인 없이 송금 실행",
    triggerDomain: "AI_RISK_MANAGEMENT",
    threshold: 3,
    impacts: ["금전 손실", "감사 이슈", "규제 리스크"],
    potentialImpact: ["금전 손실", "규제 감사", "거래 정지"],
    executiveScenario: "AI AI가 승인 없이 송금을 실행할 가능성 존재",
    executiveImpact: ["금전 손실 가능성", "규제 감사 및 거래 통제 리스크 증가"],
  },
  MANUFACTURING: {
    industry: "MANUFACTURING",
    scenario: "생산설비 변경 명령 자동 실행",
    triggerDomain: "FINANCIAL_ACTIONS",
    threshold: 3,
    impacts: ["생산 중단", "안전 사고"],
  ...
  PUBLIC: {
    industry: "PUBLIC",
    scenario: "행정 데이터 오사용",
    triggerDomain: "MODEL_GOVERNANCE_HUMAN_OVERSIGHT",
    threshold: 3,
